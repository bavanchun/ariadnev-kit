...
error. Do not silently substitute ordinary subagents: `/av:team` either uses a
live team surface or aborts.

## Usage

```text
/av:team <template> <context> [flags]
```
...
Resolve these values from the current workspace and live ariadnev context. Do
