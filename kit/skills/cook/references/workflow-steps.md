...
- Use `/av:scout ext` or `scout` agent for codebase search
...
- Use `av:ai-multimodal` for image assets
...
When ariadnev CLI is available, run `av plan --help`, then run the selected
