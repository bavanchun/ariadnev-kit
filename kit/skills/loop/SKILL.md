...
# av:loop — Autonomous Optimization Loop
...
|-----------|-------------|
| Subjective goals ("make it cleaner") | `av:cook` |
| Bug fixing with known root cause | `av:fix` or `av:debug` |
| One-shot tasks, no repetition needed | `av:cook` |
| No mechanical metric to measure progress | `av:cook --interactive` |
