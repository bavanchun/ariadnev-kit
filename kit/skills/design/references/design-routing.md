...
**Brand:**
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/av-brand/scripts/inject-brand-context.cjs
node ${CLAUDE_PLUGIN_ROOT}/skills/av-brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/av-design-system/scripts/generate-tokens.cjs -c tokens.json
node ${CLAUDE_PLUGIN_ROOT}/skills/av-design-system/scripts/validate-tokens.cjs -d src/
```
