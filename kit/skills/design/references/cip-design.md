...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/search.py "tech startup" --cip-brief -b "BrandName"
```
...
```bash
# Deliverables
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/search.py "business card letterhead" --domain deliverable

# Design styles
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/search.py "luxury premium elegant" --domain style

# Industry guidelines
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/search.py "hospitality hotel" --domain industry

# Mockup contexts
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/search.py "office reception" --domain mockup
```
...
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/generate.py --brand "TopGroup" --logo /path/to/logo.png --deliverable "business card" --industry "consulting"

# Full CIP set with logo
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/generate.py --brand "TopGroup" --logo /path/to/logo.png --industry "consulting" --set

# Pro model for 4K text rendering
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/generate.py --brand "TopGroup" --logo logo.png --deliverable "business card" --model pro

# Custom deliverables with aspect ratio
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/generate.py --brand "GreenLeaf" --logo logo.png --industry "organic food" --deliverables "letterhead,packaging,vehicle" --ratio 16:9

# Without logo (AI generates interpretation)
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/generate.py --brand "TechFlow" --deliverable "business card" --no-logo-prompt
```

### Render HTML Presentation

```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/render-html.py --brand "TopGroup" --industry "consulting" --images /path/to/cip-output
python3 ${CLAUDE_PLUGIN_ROOT}/skills/av-design/scripts/cip/render-html.py --brand "TopGroup" --industry "consulting" --images ./topgroup-cip --output presentation.html
```
