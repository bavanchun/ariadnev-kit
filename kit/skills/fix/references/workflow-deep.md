...
2. Activate `av:debug` skill (systematic-debugging + root-cause-tracing).
3. Activate `av:sequential-thinking` — structured hypothesis formation.
...
Implement per plan. Use `av:context-engineering`, `av:sequential-thinking`, `av:problem-solving`.
...
| 2 | `av:debug`, `av:sequential-thinking`, optional delegated Explore when permitted, (`av:problem-solving` auto) |
