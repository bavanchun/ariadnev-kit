...
Handled by **av:cook** skill. Bootstrap-specific notes:
...
- Asset pipeline: `av:ai-multimodal` (generate/analyze) → `imagemagick` (crop/resize) → background removal if needed
