...
3. If no logo provided: generate with `av:ai-multimodal` skill
4. Screenshot wireframes with `av:agent-browser` -> save to `./docs/wireframes/`
...
Activate **av:plan** skill: `/av:plan --auto <requirements>`
...
Activate **av:cook** skill: `/av:cook --auto <plan-path>`
