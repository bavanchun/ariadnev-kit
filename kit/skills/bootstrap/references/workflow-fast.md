...
2. If no logo provided: generate with `av:ai-multimodal` skill
3. Screenshot wireframes with `av:agent-browser` -> save to `./docs/wireframes/`
...
Activate **av:plan** skill: `/av:plan --fast <requirements>`
...
Activate **av:cook** skill: `/av:cook <plan-path>`
