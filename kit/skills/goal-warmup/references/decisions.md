...
| ID | Decision | Default |
|----|----------|---------|
| D1 | Public name | `av:goal-warmup` (keywords may include prepare; no second skill export) |
...
| D7 | Red-team | Warmup-local outcome-preserving mode only; do not change global `av:plan red-team` |
