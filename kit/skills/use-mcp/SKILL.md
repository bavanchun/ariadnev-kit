...
- Chrome DevTools MCP is profile-blind. For work requiring real Chrome cookies or an exact profile, invoke `av:chrome-profile` first and bind to the returned page selector.
