...
new `av` command or scheduler service.
...
```bash
/av:orchestrate "research three implementation options and compare them"
/av:orchestrate "compare the auth options" --internal
/av:orchestrate plans/orchestrate-jobs.yaml
/av:orchestrate plans/orchestrate-jobs.yaml --yes
/av:orchestrate --resume plans/reports/orchestrate-<timestamp>
```
