...
`/av:orchestrate` accepts YAML or turns a free-form request into YAML under the
...
for the ariadnev skill-run branch. Do not copy a candidate list into this file.
