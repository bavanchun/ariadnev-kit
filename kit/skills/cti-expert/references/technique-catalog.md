# Technique Catalog, Workflow Guides, and Skill Tiers

The three catalogues an investigation draws from: collection techniques, guided
per-role workflows, and the detail level the output is written at.
...
| `fx-dork-sweep.md` | Zero-auth Google/Bing dork sweeps — Telegram ecosystem, doc-hosts, filetype families + 4-tier fallback cascade (web_search capability → Bing → DDG → agent-browser) |
...
## Guided flows and case templates

`experience/guided-flows/` holds step-by-step interactive flows:

- `flow-person-lookup.md` — Full guided person case
- `flow-domain-sweep.md` — Guided domain sweep
- `flow-image-check.md` — Guided image verification

Activate: `/flow person` · `/flow domain` · `/flow image`

`experience/case-templates/` holds pre-built starting configurations
(`tpl-index.md` lists them):

- `tpl-due-diligence.md` — Corporate partner vetting
- `tpl-security-review.md` — Organization exposure audit
- `tpl-background-check.md` — Individual background research
