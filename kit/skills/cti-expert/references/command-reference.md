...
Every command, grouped by the AEAD phase it belongs to. `SKILL.md` covers the
lifecycle those phases form; this is the catalogue you reach for once you know
