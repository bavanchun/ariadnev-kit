...
```bash
git clone https://github.com/7onez/cti-expert.git ${CLAUDE_PLUGIN_ROOT}/skills/av-cti-expert
bash ${CLAUDE_PLUGIN_ROOT}/skills/av-cti-expert/scripts/install.sh
```
...
<sub>Generated by <code>scripts/generate-cti-docx.py</code> · HTML mirror with <code>--format html</code> via <code>scripts/generate-cti-html.py</code></sub>
