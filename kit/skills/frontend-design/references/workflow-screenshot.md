...
## Prerequisites
- Activate `av:ui-ux-pro-max` skill first for design intelligence
- Have `av:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `av:ai-multimodal` skill to extract:
...
- Remove backgrounds if needed with `av:media-processing`
