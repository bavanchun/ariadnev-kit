/**
 * Hand-rolled minimal YAML subset parser for av-journal config files.
 *
 * Supports exactly what `.ariadnev/journal.yaml` and the `journal:` block of
 * `.ariadnev/config.yaml` / `~/.ariadnev/config.yaml` need:
