...
2. `<project>/.ariadnev/.env` — project-scoped, preferred.
...
Add `.ariadnev/.env` to your project's `.gitignore` — it is never meant to be
committed:
...
own copy (see the av-seo skill's `scripts/env-loader.cjs` for the pattern this
mirrors).
