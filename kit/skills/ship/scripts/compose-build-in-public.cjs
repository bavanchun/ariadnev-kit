#!/usr/bin/env node
/**
 * compose-build-in-public.cjs — pure draft composer for `av ship --social`.
 *
 ...
 * shape documented in `references/release-and-social-workflow.md`'s "Social publish" step.
 ...
 * (e.g. via the installed av-copywriting skill) BEFORE or AFTER calling this
 * composer, same as av-journal's per-channel body layering.
 *
 ...
 *
 * CLI usage (see `references/release-and-social-workflow.md` for the full av-ship step):
