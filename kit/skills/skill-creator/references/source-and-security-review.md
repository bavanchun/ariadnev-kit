...
For an upstream distillation:

1. record source id, exact version, canonical digest, relation, and pin date;
2. extract candidate operational claims from the pinned source;
