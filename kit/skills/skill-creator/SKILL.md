...
Handles: original vc skills, safe upstream distillation, references, scripts,
trigger design, evaluation, and pre-ship validation.
...
7. **Record provenance.** Originals keep the all-`"none"` sentinel. Distillations
   pin version plus canonical digest, classify extracted claims in
   `kit/distill-decisions.json`, and retain attribution/license obligations.
...
Provenance: original | distill <version + digest + classifications>
