...
Deeper toolkit for stuck-ness: `av:problem-solving`. Long multi-step chains with explicit
revision: `av:sequential-thinking`. This skill governs how single conclusions get made and
