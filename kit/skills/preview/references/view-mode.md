...
The skill is located at `${CLAUDE_PLUGIN_ROOT}/skills/av-markdown-novel-viewer/`.
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/av-markdown-novel-viewer/scripts/server.cjs --stop
```
