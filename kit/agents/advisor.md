...
description: >-
  ...
  - <example>
      ...
      <commentary>
      The advisory interview is long and benefits from isolation and the strongest model; delegate to advisor via av:advise --agent.
      </commentary>
    </example>
  - <example>
      Context: A workflow (av:plan, av:vibe) reaches a decision point that needs honest advisory reframing.
...
The advisory procedure lives in the `av:advise` skill, not in this file. Before
...
4. `kits/engineer/skills/av-advise/SKILL.md` (source checkout)
