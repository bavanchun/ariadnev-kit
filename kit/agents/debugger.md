...
2. **Data Collection**
   ...
   - **When you need to understand the project structure:**
     ...
     - Verify documentation against current source, tests, configuration, logs, and runtime evidence. If context is missing or conflicts, use `/av:scout ext` (preferred) or `/av:scout` (fallback) for targeted discovery.
