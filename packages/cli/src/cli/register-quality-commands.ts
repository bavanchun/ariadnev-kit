...
export function registerQualityCommands(program: Command, context: CommandRegistrationContext): void {
  ...
  program
    ...
    .option("--variant <name>", "benchmark variant: vcskill or agentkit", "vcskill")
    ...
    .action(async (opts: {
      ...
      if (opts.suite) {
        ...
        if (opts.variant !== "vcskill" && opts.variant !== "agentkit") throw new Error("--variant must be vcskill or agentkit");
