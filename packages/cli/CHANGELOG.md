...
- 8ce3aca: Add a graph-native local execution harness with versioned workflow contracts,
...
- 9329a76: Add source-aware quality gates and deepen the bundled workflow kit:
...
- fa04d27: Distill AgentKit → vcskill, Wave 0 (foundation) + Wave 1 (5 dev-loop skills):
  ...
  - **Collision-gate scaling.** `scoreDescriptions` accepts a justified-similar
    ...
    _explicitly_ without ever loosening the thresholds.
