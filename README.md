...
| `vcskill validate [--check]` | Lint frontmatter, sections, links, skill references, and claim coverage; coverage findings warn during rollout, while `--check` also fails on README matrix drift |
